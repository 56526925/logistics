...
@Api(tags="物流交运")
@RestController
@RequestMapping("/modules/needtotracknumber123")
public class UBI123Controller extends JeecgController<Needtotracknumber123, INeedtotracknumber123Service> {
   @Autowired
...
//   private String url="http://192.168.1.8:8008";
   ...
   public Result<?> queryPageList(Needtotracknumber123 needtotracknumber123,
                                  @RequestParam(name="pageNo", defaultValue="1") Integer pageNo,
                                  @RequestParam(name="pageSize", defaultValue="10") Integer pageSize,
                                  HttpServletRequest req) {
       QueryWrapper<Needtotracknumber123> queryWrapper = QueryGenerator.initQueryWrapper(needtotracknumber123, req.getParameterMap());
       Page<Needtotracknumber123> page = new Page<Needtotracknumber123>(pageNo, pageSize);
       IPage<Needtotracknumber123> pageList = needtotracknumber123Service.page(page, queryWrapper);
   ...
   public Result<?> add(@RequestBody Needtotracknumber123 needtotracknumber123) {
       needtotracknumber123Service.save(needtotracknumber123);
   ...
   public Result<?> edit(@RequestBody Needtotracknumber123 needtotracknumber123) {
       needtotracknumber123Service.updateById(needtotracknumber123);
   ...
   public Result<?> delete(@RequestParam(name="id",required=true) String id) {
       needtotracknumber123Service.removeById(id);
   ...
   public Result<?> deleteBatch(@RequestParam(name="ids",required=true) String ids) {
       this.needtotracknumber123Service.removeByIds(Arrays.asList(ids.split(",")));
   ...
   public Result<?> queryById(@RequestParam(name="id",required=true) String id) {
       Needtotracknumber123 needtotracknumber123 = needtotracknumber123Service.getById(id);
       return Result.ok(needtotracknumber123);
   }
 ...
 public ModelAndView exportXls(HttpServletRequest request, Needtotracknumber123 needtotracknumber123) {
     return super.exportXls(request, needtotracknumber123, Needtotracknumber123.class, "物流交运");
 }
 ...
 public Result<?> importExcel(HttpServletRequest request, HttpServletResponse response) {
     return super.importExcel(request, response, Needtotracknumber123.class);
 }
 //获取渠道
 ...
 public Result<?> getChannels(HttpServletRequest request) {
     ...
     TrackResultModel resultModel = needtotracknumber123Service.getChannels(key,token);
     if (resultModel.getFlag() == 0) {
         try {
             ...
             for (int i = 0; i < channels.size(); i++) {
                 ...
                 logisticschannel.setLogisticsId(123);
                 logisticschannel.setCode(channel.getString("serviceCode"));
                 logisticschannel.setName(channel.getString("serviceName"));
                 logisticschannel.setLogisticsName("UBI");
