...
import org.baifei.modules.entity.request.zyhw.ZyhwItem;
import org.baifei.modules.entity.request.zyhw.ZyhwRequestStep1;
...
import org.baifei.modules.webservice.zyhw.EcSOAPStub;
import org.baifei.modules.webservice.zyhw.Ec_ServiceLocator;
...
//    private String appKey = "d3fa78fb1613cfd561320c895bf0a48d";
    ...
    public TrackResultModel runStep1(TrackModel trackModel){
        ...
        try{
            ...
            // Test operation
            String value = null;
            value = binding.callService(paramsJson, mylogisticsaccount.getToken(), mylogisticsaccount.getAccessKey(), "createOrder");
    ...
    public TrackResultModel runStep2(TrackModel trackModel){
        ...
        //测试
//        order0.setPlatformorderid("11210503661750665");
//        mylogisticsaccount.setToken("1985b9c098397b91fa8607fd591177e2");
//        mylogisticsaccount.setAccessKey("da4689ae01b69a7216532a7819d22519 ");
        try{
            ...
            // Test operation
            String value = null;
            value = binding.callService(paramsJson, mylogisticsaccount.getToken(), mylogisticsaccount.getAccessKey(),"getOrderByRefCode");
    ...
    public TrackResultModel getWarehouse(String appToken,String appKey){
        ...
        try{
            ...
            // Test operation
            String value = null;
            value = binding.callService("{}", appToken, appKey, "getWarehouse");
    ...
    public TrackResultModel getChannels(String appToken,String appKey,String wareHouseCode){
        ...
        try{
            ...
            // Test operation
            String value = null;
            value = binding.callService(paramsJson, appToken, appKey, "getShippingMethod");
    ...
    public  String getDataStep1(TrackModel trackModel){
        ...
        ZyhwRequestStep1 requestStep1 = new ZyhwRequestStep1();
        //订单参考号(建议使用平台单号)
        ...
        //订单明细
        List<ZyhwItem> itemList = new ArrayList<>();
        for(Orderitem0 orderitem0 :orderitem0List){
            ZyhwItem item= new ZyhwItem();
